<?php
  ...
  $entrydate = $_POST['theyear']."-".$_POST['themonth']."-".$_POST['theday'];

  echo "<p>The date TABLE is: <strong>".$newdate."</strong></p>";


  $select = "SELECT * FROM clockify_API.$newdate WHERE Name LIKE '".$_POST['thename']."%' AND Entry_Date = '".$entrydate."' AND Tag = 'undefined';";
  ...
  if($count != 0){
    ...
    echo "<p><a href='Hours_per_day.html'>BACK</a></p>";
